...
class MyTaskInfo extends React.Component {

    componentWillMount(){
        Messages.emit('MyTaskInfo:queryList');
        Messages.emit('MyTaskInfo:queryUserList');
    }
                                        ...
                                        <div className="modal-body">
                                            <ul>
                                                ...
                                                <li>
                                                    <div className="inline">
                                                        <h5>添加人</h5>
                                                        <input type="text" placeholder="添加人" value={appStore.data().get("create_name")} disabled="disabled" />
                                                    </div>
                                                </li>
                                                <li>
                                                    <div className="inline">
                                                        ...
                                                        <select name="" className="form-input" onChange={that._changeState.bind(that)}>
                                                            ...
                                                            <option value="3" selected={appStore.data().get("state") == 3 ? "selected" : ""}>废弃</option>
                                                        </select>
                                                    </div>
                                                </li>
                                            </ul>
    ...
    _saveTask() {
        Messages.emit('MyTaskInfo:saveTask');
    }
}

export default withRouter(connectToStore(appStore, true)(MyTaskInfo));