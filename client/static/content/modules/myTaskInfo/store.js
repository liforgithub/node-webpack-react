...
Messages.on('MyTaskInfo:queryList', () => {
    Request.post('/queryList', {
        ...
        execute_name: CommonInfo.getUserInfo().nickName,
...
Messages.on('MyTaskInfo:queryUserList', () => {
...
Messages.on('MyTaskInfo:saveTask', () => {
    Request.post('/saveTask', {
        ...
        execute_name: CommonInfo.getUserInfo().authority == 2 ? "迅达" : CommonInfo.getUserInfo().nickName,
